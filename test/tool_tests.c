...
void test_tool()
{
    ...
    u_assert_int_eq(pubkey_from_privatekey(&dogecoin_chainparams_main, "KxDQjJwvLdNNGhsipGgmceWaPjRndZuaQB9B2tgdHsw5sQ8Rtqje", pubkey, &pubkeylen), 0);
    ...
    u_assert_int_eq(hd_derive(&dogecoin_chainparams_main, "dgpv51eADS3spNJh9jYHA541MVTWDT3Rbx2oG49XKQDce4yJehwQzQ6vt8sscpKGeWm8xAoxv5KE2dvcPBk2PhLNkYBBFwjZuHfGFCnGpUg3w99", "m/1", extout, extoutsize), true);
    ...
    u_assert_int_eq(hd_derive(&dogecoin_chainparams_main, "dgpv51eADS3spNJh9uouguKrH4W3GjsMfmKwKSibvuLEvXMUSm4PKXEX7kHoYNMYcdV6U9bDWQaBK2KBmmSwjnJgjU8KDfKrnRNU1skK3cd6n7X", "m/1'", extout, extoutsize), true);
    ...
    u_assert_int_eq(hd_derive(&dogecoin_chainparams_main, "dgpv51eADS3spNJh9gCpE1AyQ9NpMGkGh6MJKxM84Tf87KVLNeodEW76V2nJJRPorYLGnvZGJKTgEgvqGCtf9VS9RqhfJaTxV7iqm86VpMUNi5G", "m/1", extout, extoutsize), true);
