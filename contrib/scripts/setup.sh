...
COMMON_PACKAGES="autoconf automake autotools-dev bison build-essential curl ca-certificates libtool libtool-bin pkg-config procps python3 python3-venv rsync valgrind"
ARCH_PACKAGES=""
OS_PACKAGES=""
DEPENDS=""
DOCKER=0
