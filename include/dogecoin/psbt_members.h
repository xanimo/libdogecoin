...
LIBDOGECOIN_API int dogecoin_psbt_get_global_tx_alloc(const struct dogecoin_psbt *psbt, struct libdogecoin_tx **output);
...
/* Inputs */
LIBDOGECOIN_API int dogecoin_psbt_get_input_utxo_alloc(const struct dogecoin_psbt *psbt, size_t index, struct libdogecoin_tx **output);
LIBDOGECOIN_API int dogecoin_psbt_get_input_witness_utxo_alloc(const struct dogecoin_psbt *psbt, size_t index, struct libdogecoin_tx_output **output);
/* Returns the witness UTXO if present, otherwise the correct output from the non-witness UTXO tx */
LIBDOGECOIN_API int dogecoin_psbt_get_input_best_utxo_alloc(const struct dogecoin_psbt *psbt, size_t index, struct libdogecoin_tx_output **output);
...
LIBDOGECOIN_API int dogecoin_psbt_get_input_final_witness_alloc(const struct dogecoin_psbt *psbt, size_t index, struct libdogecoin_tx_witness_stack **output);
...
LIBDOGECOIN_API int dogecoin_psbt_set_input_utxo(struct dogecoin_psbt *psbt, size_t index, const struct libdogecoin_tx *utxo);
LIBDOGECOIN_API int dogecoin_psbt_set_input_witness_utxo(struct dogecoin_psbt *psbt, size_t index, const struct libdogecoin_tx_output *witness_utxo);
LIBDOGECOIN_API int dogecoin_psbt_set_input_witness_utxo_from_tx(struct dogecoin_psbt *psbt, size_t index, const struct libdogecoin_tx *utxo, uint32_t utxo_index);
...
LIBDOGECOIN_API int dogecoin_psbt_set_input_final_witness(struct dogecoin_psbt *psbt, size_t index, const struct libdogecoin_tx_witness_stack *final_witness);
